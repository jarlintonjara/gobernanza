<div class="bg-light lter b-b wrapper-md">
    <h1 class="m-n font-thin h3">Creación de Eventos</h1>
</div>
...
<div class="wrapper-md">
    <div class="tab-container">
        ...
        <?php echo form_open_multipart('producto/eventos/cu_eventos');?>
            ...
            <div class="tab-pane active" id="tab1">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php echo form_hidden('id_evento', $id_evento);?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php 
                                if(!empty($img_print)){
                                    echo '<img src="'.base_url().'uploads/eventos/'.$id_evento.'/'.$img_print.'" style="margin-bottom:10px;  width: 500px;">';
                                } 
